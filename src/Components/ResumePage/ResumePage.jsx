  ...
  return (
    <div className='resume-page-container'>
      <div className='resume-page-left'>
        <ul><h3 className='tech-skill' onMouseEnter={() => setHoveredSection('tech-skill')} onMouseLeave={() => setHoveredSection('')}>Technical Skills</h3><div></div>
          <li>Python</li>
          <li>JavaScript</li>
          <li>HTML/CSS</li>
          <li>C#</li>
        ...
        <ul><h3 className='edu-exp' onMouseEnter={() => setHoveredSection('edu-exp')} onMouseLeave={() => setHoveredSection('')}>Education</h3>
        ...
        <ul><h3 className='work-exp' onMouseEnter={() => setHoveredSection('work-exp')} onMouseLeave={() => setHoveredSection('')}>Work Experience</h3>
